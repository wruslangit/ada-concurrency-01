...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main_ada_tasks_01" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#2080d3a1#;
   pragma Export (C, u00001, "main_ada_tasks_01B");
   ...
   u00114 : constant Version_32 := 16#6bf5e3cb#;
   pragma Export (C, u00114, "pkg_ada_dtstampB");
   u00115 : constant Version_32 := 16#1c176852#;
   pragma Export (C, u00115, "pkg_ada_dtstampS");
   u00116 : constant Version_32 := 16#9a2e29aa#;
   pragma Export (C, u00116, "ada__calendarB");
   u00117 : constant Version_32 := 16#c4f07049#;
   pragma Export (C, u00117, "ada__calendarS");
   u00118 : constant Version_32 := 16#51f2d040#;
   pragma Export (C, u00118, "system__os_primitivesB");
   u00119 : constant Version_32 := 16#41c889f2#;
   pragma Export (C, u00119, "system__os_primitivesS");
   u00120 : constant Version_32 := 16#10f667b3#;
   pragma Export (C, u00120, "ada__calendar__formattingB");
   u00121 : constant Version_32 := 16#f87a094f#;
   pragma Export (C, u00121, "ada__calendar__formattingS");
   u00122 : constant Version_32 := 16#e3cca715#;
   pragma Export (C, u00122, "ada__calendar__time_zonesB");
   u00123 : constant Version_32 := 16#f21593b3#;
   pragma Export (C, u00123, "ada__calendar__time_zonesS");
   u00124 : constant Version_32 := 16#d763507a#;
   pragma Export (C, u00124, "system__val_intB");
   u00125 : constant Version_32 := 16#0e90c63b#;
   pragma Export (C, u00125, "system__val_intS");
   u00126 : constant Version_32 := 16#1d9142a4#;
   pragma Export (C, u00126, "system__val_unsB");
   u00127 : constant Version_32 := 16#621b7dbc#;
   ...
   u00132 : constant Version_32 := 16#42a257f7#;
   ...
   u00134 : constant Version_32 := 16#a6c9af38#;
   ...
   u00136 : constant Version_32 := 16#4fc9bc76#;
   pragma Export (C, u00136, "ada__command_lineB");
   u00137 : constant Version_32 := 16#3cdef8c9#;
   pragma Export (C, u00137, "ada__command_lineS");
   u00138 : constant Version_32 := 16#eb4fc41d#;
   pragma Export (C, u00138, "ada__real_timeB");
   u00139 : constant Version_32 := 16#69ea8064#;
   pragma Export (C, u00139, "ada__real_timeS");
   u00140 : constant Version_32 := 16#c05c480c#;
   pragma Export (C, u00140, "system__taskingB");
   u00141 : constant Version_32 := 16#d15fc24c#;
   pragma Export (C, u00141, "system__taskingS");
   u00142 : constant Version_32 := 16#c333d44f#;
   pragma Export (C, u00142, "system__task_primitivesS");
   u00143 : constant Version_32 := 16#02d5b781#;
   pragma Export (C, u00143, "system__os_interfaceB");
   u00144 : constant Version_32 := 16#8b11eeee#;
   pragma Export (C, u00144, "system__os_interfaceS");
   u00145 : constant Version_32 := 16#ff1f7771#;
   pragma Export (C, u00145, "system__linuxS");
   u00146 : constant Version_32 := 16#198dbba9#;
   pragma Export (C, u00146, "system__os_constantsS");
   u00147 : constant Version_32 := 16#3d3b214a#;
   pragma Export (C, u00147, "system__task_primitives__operationsB");
   u00148 : constant Version_32 := 16#69ee9f34#;
   ...
   u00150 : constant Version_32 := 16#24a21b5f#;
   ...
   u00152 : constant Version_32 := 16#7e997377#;
   pragma Export (C, u00152, "system__multiprocessorsS");
   u00153 : constant Version_32 := 16#375a3ef7#;
   pragma Export (C, u00153, "system__task_infoB");
   u00154 : constant Version_32 := 16#1c069690#;
   pragma Export (C, u00154, "system__task_infoS");
   u00155 : constant Version_32 := 16#f2eb7df6#;
   pragma Export (C, u00155, "system__tasking__debugB");
   u00156 : constant Version_32 := 16#aea59d30#;
   ...
   u00164 : constant Version_32 := 16#577ab9d5#;
   ...
   u00171 : constant Version_32 := 16#60da0992#;
   pragma Export (C, u00171, "ada__strings__searchB");
   u00172 : constant Version_32 := 16#c1ab8667#;
   pragma Export (C, u00172, "ada__strings__searchS");
   u00173 : constant Version_32 := 16#acee74ad#;
   pragma Export (C, u00173, "system__compare_array_unsigned_8B");
   u00174 : constant Version_32 := 16#ef369d89#;
   pragma Export (C, u00174, "system__compare_array_unsigned_8S");
   u00175 : constant Version_32 := 16#a8025f3c#;
   pragma Export (C, u00175, "system__address_operationsB");
   u00176 : constant Version_32 := 16#55395237#;
   pragma Export (C, u00176, "system__address_operationsS");
   u00177 : constant Version_32 := 16#adb6d201#;
   pragma Export (C, u00177, "ada__strings__fixedB");
   u00178 : constant Version_32 := 16#a86b22b3#;
   pragma Export (C, u00178, "ada__strings__fixedS");
   u00179 : constant Version_32 := 16#a3db8081#;
   pragma Export (C, u00179, "ada__strings__unboundedB");
   u00180 : constant Version_32 := 16#f39c7224#;
   pragma Export (C, u00180, "ada__strings__unboundedS");
   u00181 : constant Version_32 := 16#2e260032#;
   pragma Export (C, u00181, "system__storage_pools__subpoolsB");
   u00182 : constant Version_32 := 16#cc5a1856#;
   pragma Export (C, u00182, "system__storage_pools__subpoolsS");
   u00183 : constant Version_32 := 16#d96e3c40#;
   pragma Export (C, u00183, "system__finalization_mastersB");
   u00184 : constant Version_32 := 16#1dc9d5ce#;
   pragma Export (C, u00184, "system__finalization_mastersS");
   u00185 : constant Version_32 := 16#7268f812#;
   pragma Export (C, u00185, "system__img_boolB");
   u00186 : constant Version_32 := 16#b3ec9def#;
   pragma Export (C, u00186, "system__img_boolS");
   u00187 : constant Version_32 := 16#6d4d969a#;
   pragma Export (C, u00187, "system__storage_poolsB");
   u00188 : constant Version_32 := 16#65d872a9#;
   pragma Export (C, u00188, "system__storage_poolsS");
   u00189 : constant Version_32 := 16#84042202#;
   pragma Export (C, u00189, "system__storage_pools__subpools__finalizationB");
   u00190 : constant Version_32 := 16#fe2f4b3a#;
   pragma Export (C, u00190, "system__storage_pools__subpools__finalizationS");
   u00191 : constant Version_32 := 16#020a3f4d#;
   pragma Export (C, u00191, "system__atomic_countersB");
   u00192 : constant Version_32 := 16#f269c189#;
   pragma Export (C, u00192, "system__atomic_countersS");
   u00193 : constant Version_32 := 16#039168f8#;
   ...
   u00195 : constant Version_32 := 16#27d2953a#;
   pragma Export (C, u00195, "ada__strings__unbounded__text_ioB");
   u00196 : constant Version_32 := 16#2e5d93ef#;
   pragma Export (C, u00196, "ada__strings__unbounded__text_ioS");
   u00197 : constant Version_32 := 16#276453b7#;
   pragma Export (C, u00197, "system__img_lldB");
   u00198 : constant Version_32 := 16#b517e56d#;
   pragma Export (C, u00198, "system__img_lldS");
   u00199 : constant Version_32 := 16#bd3715ff#;
   pragma Export (C, u00199, "system__img_decB");
   u00200 : constant Version_32 := 16#e818e5df#;
   pragma Export (C, u00200, "system__img_decS");
